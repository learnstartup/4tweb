...
;(function(){
	...
	//图片上传
	var swfu;
	Wind.js(GV.JS_ROOT +'util_libs/swfupload/plugins/swfupload.queue.js?v='+ GV.JS_VERSION, GV.JS_ROOT +'util_libs/swfupload/plugins/swfupload.cookies.js?v='+ GV.JS_VERSION, GV.JS_ROOT +'util_libs/swfupload/plugins/swfupload.swfobject.js?v='+ GV.JS_VERSION, function(){
				...
				try {
					switch (errorCode) {
						case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
							alert("您上传的图片\""+ file.name +"\"太大了"+ "，单张最大限制为: " + this.settings.file_size_limit);
							break;
