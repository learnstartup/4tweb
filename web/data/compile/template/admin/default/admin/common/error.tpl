...
<meta http-equiv="refresh" content="2;url=<?php echo htmlspecialchars($referer, ENT_QUOTES, 'UTF-8');?>">
<?php  } ?>
</head>
<body>
<div class="wrap">
	<div id="error_tips">
		...
		<div class="error_cont">
			...
			<?php if($referer):?>
			<div class="error_return"><a href="<?php echo htmlspecialchars($referer, ENT_QUOTES, 'UTF-8');?>" class="btn">返回</a></div>
			<?php else:?>
