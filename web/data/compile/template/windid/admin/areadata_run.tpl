			...
			<tr>
				...
				<td>
					<div class="yarnball mr20 fl">
						<ul class="cc">
							<li id="J_yarnball_all" class="<?php echo htmlspecialchars($route['all']['disable'], ENT_QUOTES, 'UTF-8');?>"><a class="J_yarnball" href="#" data-type="all" data-id="">全部</a><em></em></li>
							<li id="J_yarnball_province" class="<?php echo htmlspecialchars($route['province']['disable'], ENT_QUOTES, 'UTF-8');?>" style="<?php echo htmlspecialchars($route['province']['display'], ENT_QUOTES, 'UTF-8');?>"><a class="J_yarnball" href="" data-type="province" data-id="<?php echo htmlspecialchars($route['province']['areaid'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($route['province']['name'], ENT_QUOTES, 'UTF-8');?></a><em></em></li>
							<li id="J_yarnball_city" class="li_disabled" style="<?php echo htmlspecialchars($route['city']['display'], ENT_QUOTES, 'UTF-8');?>"><a class="J_yarnball" href="" data-id="<?php echo htmlspecialchars($route['city']['areaid'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($route['city']['name'], ENT_QUOTES, 'UTF-8');?></a><em></em></li>
						</ul>
					</div>
<?php if ($hasLevel) {?>
...
<?php }?>
	...
	<form class="J_ajaxForm J_loading_show" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=windid&c=areadata&a=update'; ?>" method="post" style="display:none;">
	<input id="J_parentid" type="hidden" value="<?php echo htmlspecialchars($areaid, ENT_QUOTES, 'UTF-8');?>" name="parentid" />
...
foreach ($list as $_i) {?>
			<tr>
				<th data-id="<?php echo htmlspecialchars($_i['areaid'], ENT_QUOTES, 'UTF-8');?>"><div class="J_items"><?php echo htmlspecialchars($_i['name'], ENT_QUOTES, 'UTF-8');?></div></th>
				<td><?php if ($hasLevel < 2) {?>
					<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?parentid=', rawurlencode($_i['areaid']),'&m=windid&c=areadata'; ?>" class="mr10 J_region_next" data-name="<?php echo htmlspecialchars($_i['name'], ENT_QUOTES, 'UTF-8');?>" data-type="<?php echo htmlspecialchars($data_role, ENT_QUOTES, 'UTF-8');?>" data-id="<?php echo htmlspecialchars($_i['areaid'], ENT_QUOTES, 'UTF-8');?>">[<?php echo htmlspecialchars($data_name, ENT_QUOTES, 'UTF-8');?>]</a>
					<?php }?>
					<a data-id="<?php echo htmlspecialchars($_i['areaid'], ENT_QUOTES, 'UTF-8');?>" data-role="<?php echo htmlspecialchars($data_role, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?areaid=', rawurlencode($_i['areaid']),'&m=windid&c=areadata&a=delete'; ?>" class="J_region_del">[删除]</a></td>
			</tr>
<?php }?>
		</tbody>
		</table>
...
<div class="core_pop_wrap" id="J_region_pop" style="display:none;">
	<div class="core_pop">
		<form action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=windid&c=areadata'; ?>" method="post">
...
Wind.use('dialog', 'draggable', function() {
	...
	//table列表中省市区的html
	var tr_province = '<tr><th data-id="_ID"><div class="J_items">_TEXT</div></th><td><a data-id="_ID" data-type="province" class="mr10 J_region_next" data-name="_PNAME" href="#">[下级城市]</a><a class="J_region_del" data-role="province" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?areaid=_ID&m=windid&c=areadata&a=delete'; ?>" data-id="_ID">[删除]</a></td></tr>',
		tr_city = '<tr><th data-id="_ID"><div class="J_items">_TEXT</div></th><td><a data-id="_ID" data-type="city" class="mr10 J_region_next" data-name="_CNAME" href="#">[下级区县]</a><a class="J_region_del" data-role="city" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?areaid=_ID&m=windid&c=areadata&a=delete'; ?>" data-id="_ID">[删除]</a></td></tr>',
		tr_district = '<tr><th data-id="_ID"><div class="J_items">_TEXT</div></th><td><a class="J_region_del" data-role="district" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?areaid=_ID&m=windid&c=areadata&a=delete'; ?>" data-id="_ID">[删除]</a></td></tr>';
