...
<div class="wrap">
	...
	<form method="post" class="J_ajaxForm" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=pay&a=dorun'; ?>" data-role="list">
	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				...
				<td>
					<ul class="switch_list cc">
						<li><label><input name="ifopen" value="1" type="radio" <?php echo htmlspecialchars(Pw::ifcheck($config['ifopen']), ENT_QUOTES, 'UTF-8');?>><span>开启</span></label></li>
						<li><label><input name="ifopen" value="0" type="radio" <?php echo htmlspecialchars(Pw::ifcheck(!$config['ifopen']), ENT_QUOTES, 'UTF-8');?>><span>关闭</span></label></li>
					</ul>
				</td>
			...
			<tr>
				<th>网上支付功能关闭原因</th>
				<td>
					<textarea name="reason" class="length_5"><?php echo htmlspecialchars($config['reason'], ENT_QUOTES, 'UTF-8');?></textarea>
				</td>
				<td class="td_tips"><div></div></td>
			</tr>
		</table>
	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				...
				<td>
					<select class="select_3 J_alipay_interface" name="alipayinterface">
						<option value="0"<?php echo htmlspecialchars(Pw::isSelected(!$config['alipayinterface']), ENT_QUOTES, 'UTF-8');?>>双功能收款(推荐)</option>
						<option value="1"<?php echo htmlspecialchars(Pw::isSelected($config['alipayinterface']), ENT_QUOTES, 'UTF-8');?>>即时到帐收款</option>
					</select>
				</td>
			...
			<tr>
				<th>支付宝帐号</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['alipay'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="alipay">
				</td>
			...
			<tr>
				<th>合作者身份(PID)</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['alipaypartnerID'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="alipaypartnerID">
				</td>
			...
			<tr>
				<th>安全校验码(KEY)</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['alipaykey'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="alipaykey">
				</td>
	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				<th>财付通帐号</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['tenpay'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="tenpay">
				</td>
			...
			<tr>
				<th>财付通密钥</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['tenpaykey'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="tenpaykey">
				</td>
				<td class="td_tips"><div></div></td>
			</tr>
		</table>
	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				<th>贝宝帐号</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['paypal'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="paypal">
				</td>
			...
			<tr>
				<th>贝宝密钥</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['paypalkey'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="paypalkey">
				</td>
				<td class="td_tips"><div></div></td>
			</tr>
		</table>
	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				<th>快钱帐号</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['99bill'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="99bill">
				</td>
			...
			<tr>
				<th>快钱密钥</th>
				<td>
					<input type="text" value="<?php echo htmlspecialchars($config['99billkey'], ENT_QUOTES, 'UTF-8');?>" class="input length_5" name="99billkey">
				</td>
				<td class="td_tips"><div></div></td>
			</tr>
		</table>
