...
class Wind {
	...
	public static function getRealPath($filePath, $suffix = '', $absolut = false) {
		...
		//if($filePath =='dongta.service.dao.App_Dongta_Dao')
		//{
		//	echo $filePath;die;
		//	echo strpos($filePath, DIRECTORY_SEPARATOR);echo "------";echo DIRECTORY_SEPARATOR;echo "here";die;
		//	echo "here".realpath($filePath);die;
		//}
