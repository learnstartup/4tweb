...
<?php }?>
	...
	<form action="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myaccount&a=orderaddress&app=4tschool'; ?>" id="myAddressForm" method="post">
	<input type="hidden" class="pageurl" name="pageurl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myaccount&a=orderaddress&app=4tschool'; ?>">
	<input type="hidden" class="deleteAddressUrl" name="deleteAddressUrl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myaccount&a=deleteOrderAddress&app=4tschool'; ?>">
	<input type="hidden" class="updateAddressUrl" name="updateAddressUrl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myaccount&a=updateOrderAddress&app=4tschool'; ?>">
	<input type="hidden" class="addressToDelete" name="addressToDelete" value=""></input>
	<input type="hidden" class="setasDefaultUrl" name="setasDefaultUrl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myaccount&a=setasDefaultAddress&app=4tschool'; ?>">
	<input type="hidden" class="editid" name="editid" value="<?php echo htmlspecialchars($editId, ENT_QUOTES, 'UTF-8');?>">
	<div class="clear"></div>
	<div class="spacer"></div>
	<div id="orderList" class="">
		<div class="my_address_info">
			<?php  if ($orderAddressList) { 
 foreach ($orderAddressList as $key => $item) {?>
			<div class="my_address">
		
				<ul>
					<li>
					<span>地址<?php echo htmlspecialchars($key+1, ENT_QUOTES, 'UTF-8');?>:</span>

					<?php  if ($item['isdefault'] == 1) { ?>
					<span style="color:blue">默认地址 </span>
					<?php  } ?>
					<span class="address_text"><?php echo htmlspecialchars($item['rname'], ENT_QUOTES, 'UTF-8');?>, <?php echo htmlspecialchars($item['raddress'], ENT_QUOTES, 'UTF-8');?>,  <?php echo htmlspecialchars($item['rphone'], ENT_QUOTES, 'UTF-8');?></span>
					</li>
					...
					<input id="btn_id" class="deleteAddress button_delete" type="hidden" value="<?php echo htmlspecialchars($item['id'], ENT_QUOTES, 'UTF-8');?>">
					</li>
				</ul>
				<div class="clear"></div>
		...
		<div class="fanye"><div class="fanye"><div>（共<?php echo htmlspecialchars($totalCount, ENT_QUOTES, 'UTF-8');?>条）</div></div></div>
	</div>
		 <form action="">
		 	<div class="my_address_info my_address_add" id="EditorPosition">
                    ...
                    <div class="my_address_add_info">
                        <p>
                            <label>
                                收货人：</label><input name="txt_ship_man" value="<?php echo htmlspecialchars($addressDetail[0]['rname'], ENT_QUOTES, 'UTF-8');?>" type="text" id="txt_ship_man"><span class="hint" id="vaild_ship_man">请填写收货人姓名</span></p>
                        
                        <p>
                            <label>
                                地址：</label><input name="txt_addr_detail"  value="<?php echo htmlspecialchars($addressDetail[0]['raddress'], ENT_QUOTES, 'UTF-8');?>"  type="text" id="txt_addr_detail" size="50"><span class="hint" id="valid_addressdetail">请填写街道地址</span></p>
                       
                        <p>
                           <label>电话：</label><input name="txt_ship_tel"  value="<?php echo htmlspecialchars($addressDetail[0]['rphone'], ENT_QUOTES, 'UTF-8');?>" type="text" id="txt_ship_tel"><span class="hint" id="vaild_tel">请填写电话</span></p>
