 ...
 * @version $Id: WindidImageThumb.php 21452 2012-12-07 10:18:33Z gao.wanggao $
 * @package lib.image
 */

class WindidImageThumb {
	...
	public function __construct(WindidImage $image) {
		$this->image = $image;
	}
	...
	public function compute() {
		switch ($this->type) {
			case self::TYPE_CENTER:
				$method = 'WindidImageThumbCenterCompute';break;
			default:
				$method = 'WindidImageThumbIntactCompute';
		}
	 ...
	 * return void
	 */
	public function makeImage($image, $filename, $quality = '75') {
...
abstract class WindidImageThumbCompute {
 ...
 * 等比缩略算法
 */
class WindidImageThumbIntactCompute extends WindidImageThumbCompute {
 ...
 * 居中截取算法
 */
class WindidImageThumbCenterCompute extends WindidImageThumbCompute {
