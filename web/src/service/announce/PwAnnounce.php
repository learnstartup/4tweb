...
class PwAnnounce {
	...
	public function getAnnounceOrderByVieworder($schoolid, $limit, $start){
		return $this->_getPwAnnounceDao()->getAnnounceOrderByVieworder($schoolid, $limit, $start);
	}
	...
	public function getAnnounceBySchoolId($schoolid, $time, $limit, $offset){
		...
		return $this->_getPwAnnounceDao()->getAnnounceBySchoolId($schoolid, $time, $limit, $offset);
	}
	...
	public function getAnnouncePageTurn($schoolid, $aid, $pagetag){
		...
		return $this->_getPwAnnounceDao()->getAnnouncePageTurn($schoolid, $aid, $pagetag);
	}
