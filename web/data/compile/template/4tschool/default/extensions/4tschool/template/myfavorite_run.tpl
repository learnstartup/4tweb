...
<div class="wrapper line new_box new_bg">
	...
	<form action="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&app=4tschool'; ?>" id="myFavoriteForm" method="post">
	<?php  if ($shopid <= 0) { ?>
	<input type="hidden" class="pageurl" name="pageurl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&app=4tschool'; ?>">
	<?php }else{?>
	<input type="hidden" class="pageurl" name="pageurl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&shopid=', rawurlencode($shopid),'&app=4tschool'; ?>">
	<?php }?>
	
	<input type="hidden" class="deleteFavoriteUrl" name="deleteFavoriteUrl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&a=delete&app=4tschool'; ?>">
	<input type="hidden" class="deleteFavoriteMUrl" name="deleteFavoriteMUrl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&a=deleteM&app=4tschool'; ?>">
 ...
 foreach ($favoriteList as $key => $item) {?>
            	<tr>
            		<td class="tab_w7">
            			<a name="productpic" href="<?php echo Wekit::app()->baseUrl,'/','school-', rawurlencode($schoolId),'-4tschool-shopdetails-run-', rawurlencode($item['shopid']),'?app=4tschool'; ?>" target="">
            			<img width="67px" height="30px" src="<?php echo htmlspecialchars($item['imageurl'], ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8');?>">
            			</a>
            		</td>
            		<td class="tab_w1">
            			<a name="productname" href="<?php echo Wekit::app()->baseUrl,'/','school-', rawurlencode($schoolId),'-4tschool-shopdetails-run-', rawurlencode($item['shopid']),'?app=4tschool'; ?>" target="" title="<?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8');?></a>
            		</td>
            		<td class="tab_w7"><?php echo htmlspecialchars($item['areaname'], ENT_QUOTES, 'UTF-8');?></td>
            		<td class="tab_w1"><?php echo htmlspecialchars($item['orderbegin'], ENT_QUOTES, 'UTF-8');?> - <?php echo htmlspecialchars($item['orderend'], ENT_QUOTES, 'UTF-8');?></td>
            		<td class="tab_w1"><span><?php echo htmlspecialchars($item['address'], ENT_QUOTES, 'UTF-8');?></span></td>
	            	<td class="tab_w1">
	            		<span class="tab_w5_online">
	            			 <a name="gotoDetail" class="gotoDetail" target="_blank" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&shopid=', rawurlencode($item['shopid']),'&schoolid=', rawurlencode($schoolId),'&app=4tschool'; ?>">[详情]</a>
	            		</span>
	            		<span class="tab_w5_online">
	            			 <a name="deleteFavorite" class="deleteFavorite" target="_blank" href="<?php echo htmlspecialchars($item['shopid'], ENT_QUOTES, 'UTF-8');?>">[删除]</a>
	            		</span>
	            	</td>
            	</tr>
	            <?php }
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&page=', rawurlencode($_page_i),'&app=4tschool'; 
...
<?php } ?>
  ...
  if ($shopid > 0) { ?>
	<h3>
	 	店铺:
	 	<strong>
	 		<a href="<?php echo Wekit::app()->baseUrl,'/','school--4tschool-shopdetails-run-', rawurlencode($shopInfo['id']),'?app=4tschool'; ?>"><?php echo htmlspecialchars($shopInfo['name'], ENT_QUOTES, 'UTF-8');?></a>
	 	</strong>
	</h3><br/>
	<div class="merch_bord">
        <table border="0" cellpadding="0" cellspacing="0" class="tabl_merch merch_title">
 ...
 foreach ($shopItems as $key => $item) {?>
        	<tr>
        		<td class="tab_w7">
        			<!--<a name="productpic" href="<?php echo Wekit::app()->baseUrl,'/','school--4tschool-shopdetails-run-', rawurlencode($item['shopid']),'?app=4tschool'; ?>" target="">
        			<img width="67px" height="30px" src="<?php echo htmlspecialchars($item['imageurl'], ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8');?>">
        			</a>-->
        			暂不提供
        		</td>
        		<td class="tab_w1">
        			<a name="productname" href="<?php echo Wekit::app()->baseUrl,'/','school--4tschool-shopdetails-run-', rawurlencode($item['shopid']),'?app=4tschool'; ?>" target="" title="<?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($item['name'], ENT_QUOTES, 'UTF-8');?></a>
        		</td>
        		<td class="tab_w7">
            		<span class="tab_w5_online">
            			 <a name="deleteFavoriteM" class="deleteFavoriteM" target="_blank" href="<?php echo htmlspecialchars($item['merchandiseid'], ENT_QUOTES, 'UTF-8');?>">删除</a>
            		</span>
            	</td>
       		</tr>
            <?php }
...
<?php  if ($__tplPageCurrent > $_page_min) { 
	$_page_i = $__tplPageCurrent-1;
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfavorite&shopid=', rawurlencode($shopid),'&page=', rawurlencode($_page_i),'&app=4tschool'; 
