...
<?php }?>
	...
	<form action="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfeedback&app=4tschool'; ?>" id="MyFeedbackForm" method="post">
	<input type="hidden" class="pageurl" name="pageurl" value="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfeedback&app=4tschool'; ?>">
 ...
 foreach ($messageList as $key => $item) {?>
	   <li onmouseout="this.style.background='none'" onmouseover="this.style.background='#f4f4f4'" style="background-image: none; background-position: initial initial; background-repeat: initial initial;">
	   		...
	   		<span class="list_order" style="width:150px;text-align:left"><?php echo htmlspecialchars($item['question'], ENT_QUOTES, 'UTF-8');?></span>
			<span class="list_status" style="width:150px;text-align:left"><?php echo htmlspecialchars($item['reply']==''?'':$item['reply'], ENT_QUOTES, 'UTF-8');?></span>
			<span class="list_time" style="width:150px;"> <?php echo htmlspecialchars($item['createdat'], ENT_QUOTES, 'UTF-8');?></span>
			<span class="list_time" style="width:150px;"> <?php echo htmlspecialchars($item['repliedat']==""?"":$item['repliedat'], ENT_QUOTES, 'UTF-8');?></span>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myfeedback&page=', rawurlencode($_page_i),'&app=4tschool'; 
