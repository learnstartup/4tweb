...
<?php }?>
	...
	<div id="orderList" class="account_right">
		...
		<div class="mydangdang_noword">
			<div class="mydangdang_noword_text2"><span class="s14">您的当前积分是：<span class="red14_b"><?php echo htmlspecialchars($myCredit[0]['credit']==''?'0.00':$myCredit[0]['credit'], ENT_QUOTES, 'UTF-8');?></span></span><br>
			</div>
		</div>
 ...
 foreach ($creditHistory as $key => $item) {?>
			...
			<td class="list1"><?php echo htmlspecialchars($item['createdate'], ENT_QUOTES, 'UTF-8');?></td>
			<td class="list2"><?php echo htmlspecialchars($item['creditoriginal'], ENT_QUOTES, 'UTF-8');?></td>
			<td class="list2"><?php echo htmlspecialchars($item['creditincome'], ENT_QUOTES, 'UTF-8');?></td>
			<td class="list3"><?php echo htmlspecialchars($item['creditleft'], ENT_QUOTES, 'UTF-8');?></td>
			<td class="list4"><?php echo htmlspecialchars($item['description'], ENT_QUOTES, 'UTF-8');?></td>
			</tr>
			</tbody></table>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=app&c=myaccount&a=mycredit&page=', rawurlencode($_page_i),'&app=4tschool'; 
...
<?php } ?>
			...
			<div class="turnpage"><div>（共<?php echo htmlspecialchars($count, ENT_QUOTES, 'UTF-8');?>条）</div></div>
			<div class="clear"></div>
			</div>
